...
function wpeu_email_subject_field_setting()
{
    ...
    <input type="text" class="widefat" name="wpeu_register_settings_fields[wpeu_email_subject_field]" value="<?php if ( isset( $options['wpeu_email_subject_field'] ) ){ echo esc_attr( $options['wpeu_email_subject_field'] ); } else { echo 'subject'; } ?>" />
<?php }
